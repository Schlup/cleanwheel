...
const LandingPage = () => {
  return (
    <main>
      <Header />
      <div className="w-full min-h-screen bg-c11 ps-100px grid grid-cols-2 gap-[20px]">
        <div className="col-start place-self-center">
          ...
          <p className="font-roboto text-2-l text-c5 pb-5">
            Plataforma de agendamento de serviços para empresas especializadas
            em cuidados automotivos. Simplicidade no agendamento de lavação,
