...
const BusinessEmployees = () => {
    ...
    const roles = [
        { id: 1, role: 'Atendente', description: 'Atendimento ao cliente e pedidos' },
        { id: 2, role: 'Lavador', description: 'Lavagem externa e interna dos veículos' },
        { id: 3, role: 'Polidor', description: 'Polimento e aplicação de ceras' },
        { id: 4, role: 'Técnico de Higienização', description: 'Limpeza e higienização interna' },
        { id: 5, role: 'Especialista em Vitrificação', description: 'Aplicação de vitrificação e cristalização' },
        { id: 6, role: 'Aplicador de Película', description: 'Instalação de películas protetivas' },
        { id: 7, role: 'Hidratação de Couro', description: 'Limpeza e hidratação de bancos de couro' },
        { id: 8, role: 'Especialista em Proteção de Faróis', description: 'Polimento e revitalização de faróis' },
        { id: 9, role: 'Gerente de Operações', description: 'Supervisão de operações e equipe' },
        { id: 10, role: 'Especialista em Detalhamento de Motor', description: 'Limpeza detalhada do motor' }
    ];
